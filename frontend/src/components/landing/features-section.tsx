...
const AnimatedChatDemo = ({ isActive }: { isActive: boolean }) => {
	...
	useEffect(() => {
		...
		const scenarios = [
			...
			[
				{
					text: "Hello! I'm available 24/7 to assist you.",
					isBot: true,
				},
			...
			<div className="space-y-2">
				{leads.map((lead, i) => (
					<div key={i} className="flex items-center gap-2">
						<span className="text-xs text-slate-700 w-12">
							{lead.name}
						</span>
...
const features = [
	{
		...
		description:
			"Advanced AI-powered OCR technology that automatically extracts invoice data with 95%+ accuracy, eliminating manual data entry.",
	...
	},
	{
		...
		description:
			"Instant validation of extracted invoice data with automatic error detection and correction suggestions.",
	...
	},
	{
		...
		description:
			"Comprehensive analytics that track spending patterns, vendor performance, and financial trends in real-time.",
	...
	},
	{
		...
		description:
			"Conversational AI chatbot that answers questions about your invoices, spending patterns, and financial data instantly.",
	...
	},
	{
		...
		description:
			"Intelligent system that identifies spending trends, anomalies, and opportunities for cost savings across all transactions.",
	...
	},
	{
		...
		description:
			"Connect with your existing accounting software, ERP systems, and financial tools for unified invoice management.",
					...
					>
						<div className="inline-flex items-center px-4 py-2 rounded-full bg-slate-100 border border-slate-200 text-slate-700 text-sm font-medium mb-6">
							<svg
								...
								viewBox="0 0 24 24"
							>
								<path d="M14 2H6C4.9 2 4 2.9 4 4V20C4 21.1 4.9 22 6 22H18C19.1 22 20 21.1 20 20V8L14 2ZM18 20H6V4H13V9H18V20ZM10 19H8V18H10V19ZM10 17H8V16H10V17ZM10 15H8V14H10V15ZM16 19H12V18H16V19ZM16 17H12V16H16V17ZM16 15H12V14H16V15Z" />
							</svg>
						...
						<p className="text-base sm:text-lg md:text-xl text-slate-600 max-w-3xl mx-auto font-light leading-relaxed">
							Experience intelligent invoice processing with OCR
							technology, real-time analytics, and AI-powered
							insights that transform your financial workflow.
						</p>
					</div>
