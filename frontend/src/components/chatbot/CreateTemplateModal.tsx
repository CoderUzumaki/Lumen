...
interface CreateTemplateModalProps {
	isOpen: boolean;
	onClose: () => void;
	onCreateTemplate: (templateData: Partial<Template>) => void;
						...
						<form onSubmit={handleSubmit} className="space-y-4">
							...
							<div className="flex items-start gap-3 rounded-lg bg-zinc-50 p-4 dark:bg-zinc-800/50">
								...
								<div className="text-sm text-zinc-600 dark:text-zinc-400">
									...
									<div>
										Templates are perfect for frequently
										used prompts, instructions, or
										conversation starters. They'll be
										inserted directly into your chat input
										when selected.
									</div>
								</div>
							</div>
